    ...
    calendar: function(c) {
        ...
        function() {
            ...
            if ($("#" + c.controlId + ":hidden").length != 0) {
                ...
                // },
                // c.speed);
                a.css({width:'300px',height:'240px'}).fadeIn(100);
                a.bind("selectstart",
                function() {
                    return false
                }).bind("mousedown",
       ...
       $(document).mouseup(function(a) {
           if (($(a.target).parentsUntil("#" + c.controlId).parent().length == 0 || $(a.target).parentsUntil("#" + c.controlId).parent()[0].id != c.controlId)){ $("#" + c.controlId).fadeOut(100,function(){n.removeClass('active');});}
       })
    }
});
