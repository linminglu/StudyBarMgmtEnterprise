...
var classset_pcom = {
            ...
            addproportion: {
                ...
                onOk: function (param) {
                    ...
                    if (_that.addRateText_Flag == true) {
                        jQuery.postFail('','分佣比率设置错误');
                        return;
                    }
                    $.ajax({
                        data: {
                            rate: _that.addRateText / 100.0,
                            remark: '抽佣' + _that.addRateText + ".00%"
                        },
                        url: '/butlerp/business/employrateadd',
                        dataType: 'json',
                        type: 'post',
    ...
    methods: {
        ...
        seeclassinfo(index) {
            ...
            _that.refreshNavigation();
            $.ajax({
                url: '/butlerp/business/employrateuserlist',
                data: {
                    employrateid: _that.data_list[_that.dataindex].employrateid,
