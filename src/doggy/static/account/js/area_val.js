...
var province_listApi=null;
var city_listApi=null;
var area_listApi=null;
...
//当切回省份是，也自动切换成城市
function tabprovince(e){
	$("#per_province,#province,#per_city,#city,#area,#s_county").removeClass("err_input").siblings(".err_tips").remove();
	if(e=="省份"){
		$("#per_city,#city").val("城市");
		$("#area,#s_county").val("地区");
	};
}
function tabcity(e){
	$("#per_province,#province,#per_city,#city,#area,#s_county").removeClass("err_input").siblings(".err_tips").remove();
...
dsy.add("0_19_1",["福田区","罗湖区","南山区","宝安区","龙岗区","盐田区","龙华区","坪山区","大鹏新区","光明新区"]);
